...
while cap.isOpened():
    ...
    if success:
        ...
        if results.pose_landmarks:
            ...
            cv2.putText(esqueleto, f'Linea Manos: {texto_estado}', (10, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, color_texto, 2)
            #-------------------------------------------------------------
            ...
            cv2.putText(esqueleto, 'hombro derecho', (x2, y2), cv2.FONT_HERSHEY_PLAIN, 1, (0, 206, 208), 2)
            
            cv2.circle(esqueleto, (x3, y3), 6, (255,0,0),cv2.FILLED)#rightelbow
            cv2.putText(esqueleto, 'codo derecho', (x3, y3), cv2.FONT_HERSHEY_PLAIN, 1, (0, 206, 208), 2)
            ...
            cv2.putText(esqueleto, 'hombro izquierdo', (x22, y22), cv2.FONT_HERSHEY_PLAIN, 1, (0, 206, 208), 2)

            cv2.circle(esqueleto, (x33, y33), 6, (255,0,0),cv2.FILLED)#rightelbow
            cv2.putText(esqueleto, 'codo izquierdo', (x33, y33), cv2.FONT_HERSHEY_PLAIN, 1, (0, 206, 208), 2)
            ...
            cv2.putText(canva, f'Contador de repeticiones: {contador_cambios}', (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255,255, 255), 1)
            
            #esqueleto1 = cv2.addWeighted(esqueleto, 0.5, canva, 0.5, 0)

            cv2.putText(esqueleto, f'Angulo hombro derecho: {angle:.2f} grad', (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255,255, 255), 1)
            cv2.putText(esqueleto, f'                                        Angulo hombro izquierdo: {angle2:.2f} grad', (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255,255, 255), 1)
            # mp_drawing.draw_landmarks(esqueleto,
